...
export const CustomerOrderConfirmedEmail = ({
	...
	return (
		<Html>
			<Head />
			<Preview>Victorious Audio Order submitted</Preview>
				...
				<Container style={container}>
					...
					<Section>
						<Text style={stepsText}>
							...
							Thank you for choosing Victorious Audio for your recent purchase. Please hold tight
					...
					<Section>
						<Column align="center" style={ctaTitle}>
							<Text style={ctaText}>Why the wait?</Text>
						</Column>
					</Section>
					<Section>
						<span style={stepsText}>
							We're reviewing your order and will get back to you as soon as possible! So long,
							click the button below to familiarise yourself with the order process. <br />
							<br />
							...
							<br />
							<br /> Your satisfaction is our priority, and we appreciate your business.
						</span>{' '}
						<br />
						<Button
